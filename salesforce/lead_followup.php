...
$msg_email = "<html>
			...
			<body>
			<p>Dear ".$party_id.",</p>
			<p>This is to inform  that your lead no. ".str_replace(",","  ,  ",$reference)." is created successfully</p>";
...
function send_mail_fun($content,$send_to,$send_cc){
	...
	if (!$mail->send()) {
		$err_msg =  "Mailer Error: " . $mail->ErrorInfo;
		  ...
		  $msgg="Lead added successfully with reference ".$reference."";
