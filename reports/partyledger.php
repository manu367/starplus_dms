                ...
                <form class="form-horizontal table-responsive" role="form">
                    <table  width="100%" id="myTable" class="table-striped table-bordered table-hover" align="center">
                        ...
                        <tbody>
                            ...
                            $sql = mysqli_query($link1, "Select location_code,cust_id, doc_no , doc_date ,doc_type  ,amount ,cr_dr ,entry_date  from party_ledger where $locationcode and $custid $datefilter and doc_no NOT IN (SELECT doc_no FROM party_ledger where doc_type = 'CANCEL CORPORATE INVOICE' )   order by doc_date  ");			
                            while ($row = mysqli_fetch_assoc($sql)) {
