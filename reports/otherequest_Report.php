    ...
    <div class="container-fluid">
        <div class="row content">
            ...
            <div class="col-sm-9 tab-pane fade in active" id="home">
                <h2 align="center"><i class="fa fa-cubes"></i> Other Request Report </h2>
                ...
                <form class="form-horizontal" role="form" name="form1" action="" method="get">
 				<div class="form-group">
                     ...
                     <div class="form-group">
                        <div class="col-md-6"><label class="col-md-5 control-label">Request Type<span class="red_small">*</span></label>	  
                            <div class="col-md-5" align="left">
                              <select name="status" id="status" class="form-control required"  required onChange="document.form1.submit();">
                                    <option value="">Select Request</option>
                                    <option value="IR" <?php if($_REQUEST['status'] == 'IR') { echo "selected";} ?>>Apply for ID Card</option>
                                    <option value="VR"  <?php if($_REQUEST['status'] == 'VR') { echo "selected";} ?>>Apply for Visiting Card</option> 
                                    <option value="LR"  <?php if($_REQUEST['status'] == 'LR') { echo "selected";} ?>>Apply for Loan</option>
                                    <option value="TRC"  <?php if($_REQUEST['status'] == 'TRC') { echo "selected";} ?>>Travelling Claim</option>
                                    <option value="LRC"  <?php if($_REQUEST['status'] == 'LRC') { echo "selected";} ?>>Lodging Claim</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6"><label class="col-md-5 control-label"></label>	  
                            <div class="col-md-5" align="left">
                                    ...
                                    <a href="excelexport.php?rname=<?= base64_encode("otherRequestReport") ?>&rheader=<?= base64_encode("Other Request Details") ?>&status=<?= base64_encode($_REQUEST['status']) ?>&fromDate=<?= base64_encode($_REQUEST['fdate']) ?>&toDate=<?= base64_encode($_REQUEST['tdate']) ?>" title="Export leave details in excel"><i class="fa fa-file-excel-o fa-2x" title="Export leave details in excel"></i></a>
