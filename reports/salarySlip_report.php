    ...
    <div class="container-fluid">
        <div class="row content">
            ...
            <div class="col-sm-9 tab-pane fade in active" id="home">
                <h2 align="center"><i class="fa fa-inr"></i> Salary Slip </h2>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6"><label class="col-md-5 control-label"></label>	  
                            <div class="col-md-5" align="left">
                                    ...
                                    <a href="excelexport.php?rname=<?= base64_encode("salarySlipReport") ?>&rheader=<?= base64_encode("Salary Slip Details") ?>&fromDate=<?= base64_encode($_REQUEST['fdate']) ?>&toDate=<?= base64_encode($_REQUEST['tdate']) ?>" title="Export salary details in excel"><i class="fa fa-file-excel-o fa-2x" title="Export salary details in excel"></i></a>
