                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6"><label class="col-md-5 control-label"></label>	  
                            <div class="col-md-5" align="left">
								...
								$inv="DR/18-19/0031";
                                    ?>
									<div><a href="#" onClick="javascript:window.open('../pdfpage/pdf_attachment.php?invoice_no=<?=$inv?>','PrintInvoice','toolbar=no, status=no, resizable=yes, scrollbars=yes, width=860,height=700,top=50,left=350')"><img src="../img/email.jpg" border="0" width="25" title="PDF" height="25"></a>
								</div>
