...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active table-responsive" id="home">
      <h2 align="center"><i class="fa fa-address-card"></i> Receipt Approval List</h2>
     <?php if($_REQUEST['msg']!=''){?>
      	<h4 align="center">
        	<span 
          ...
          <thead>
            <tr class="<?=$tableheadcolor?>" >
              ...
              <th data-hide="phone"><a href="#" name="name" title="asc" class="not-sort"></a>Amount</th>
               <th data-hide="phone, tablet"><a href="#" name="name" title="asc" class="not-sort"></a>Receipt Date</th>
