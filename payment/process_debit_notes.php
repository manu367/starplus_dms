...
$(document).ready(function() {
	var dataTable = $('#debitnotelist-grid').DataTable( {
		"scrollX" :true,
		"processing": true,
		"serverSide": true,
		"order":  [[0,"desc"]],
		"ajax":{
			url :"../pagination/debitnotelist-grid-data.php", // json datasource
			...
			error: function(){  // error handling
				$(".debitnotelist-grid-error").html("");
				$("#debitnotelist-grid").append('<tbody class="debitnotelist-grid-error"><tr><th colspan="9">No data found in the server</th></tr></tbody>');
				$("#debitnotelist-grid_processing").css("display","none");
...
<div class="container-fluid">
  <div class="row content">
    ...
    ?>
    <div class="col-sm-9">
      <h2 align="center"><i class="fa <?=$fa_icon?>"></i>  Debit Notes Status</h2>
      ...
      <div style="display:inline-block;float:right">
       <button title="Add New" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='dr_notes_itemwise.php?op=add<?=$pagenav?>'"><span>Itemwise Debit Note</span></button>
      &nbsp;&nbsp;&nbsp;&nbsp;</div>
  <br/> <br/>
		<!--  
		<div style="display:inline-block;float:right">
		<button title="Add New" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='dr_notes.php?op=add<?=$pagenav?>'"><i class="fa fa-plus-circle fa-lg"></i>&nbsp;Amountwise Debit Note</button></div>-->
      
        <div class="form-group" id="page-wrap" style="margin-left:10px;"><br/>
      <!--<div class="form-group table-responsive"  id="page-wrap" style="margin-left:10px;"><br/><br/>-->
       <table  width="100%" id="debitnotelist-grid" class="table-striped " align="center" cellpadding="4" cellspacing="0" border="1">
          <thead>
