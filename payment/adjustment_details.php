...
<div class="container-fluid">
 <div class="row content">
          ...
          <table class="table table-bordered" width="100%">
            <tbody>
              <tr>
                ...
                <td width="30%"><?php echo str_replace("~",",",getLocationDetails($p_row['to_location'],"name,city,state",$link1));?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><label class="control-label">Adjustment Type</label></td>
                <td><?php if($p_row['adjustment_type'] == '' ){ echo "Pending for Approval";} else { echo $p_row['adjustment_type'] ;}?></td>
              </tr>
               <tr>
              ...
              <tr>
                ...
                <td><?php echo $ap_row['action_taken'];  ?></td>
  ...
  <div class="row" align="center">
              <input title="Back" type="button" class="btn btn-primary" value="Back" onClick="window.location.href='acc_adjustList.php?<?=$pagenav?>'">
  </div>
  <br><br>
 </div><!--close col-sm-9-->
