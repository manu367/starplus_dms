...
$(document).ready(function() {
	var dataTable = $('#debitnoteapprv-grid').DataTable( {
		
		"processing": true,
		"serverSide": true,
		"order":  [[0,"asc"]],
		"ajax":{
			url :"../pagination/debitnoteapprv-grid-data.php", // json datasource
			...
			error: function(){  // error handling
				$(".debitnoteapprv-grid-error").html("");
				$("#debitnoteapprv-grid").append('<tbody class="debitnoteapprv-grid-error"><tr><th colspan="9">No data found in the server</th></tr></tbody>');
				$("#debitnoteapprv-grid_processing").css("display","none");
...
<div class="container-fluid">
  <div class="row content">
    ...
    ?>
    <div class="col-sm-9">
      <h2 align="center"><i class="fa <?=$fa_icon?>"></i>  Debit Notes Approval</h2>
      ...
      <!--<div class="form-group table-responsive"  id="page-wrap" style="margin-left:10px;"><br/><br/>-->
       <table  width="100%" id="debitnoteapprv-grid" class="table-striped " align="center" cellpadding="4" cellspacing="0" border="1">
          <thead>
