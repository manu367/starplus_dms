...
$res_cn = mysqli_query($link1,"SELECT * FROM credit_note WHERE ref_no='".$pi_no."'");
$si_master = mysqli_fetch_array($res_cn);
...
<body>
	<div class="container-fluid">
    	...
    	?>
    		<div class="col-sm-9">
      			<h2 align="center"><i class="fa <?=$fa_icon?>"></i> View  Credit Note</h2>
         			...
         			<div class="panel-group">
              					...
              					<table class="table table-bordered" width="100%">
                					<tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo  $get_result_user=getAdminDetails($si_master['create_by'],"name",$link1)."(".$si_master['create_by'].")"; ?></td>
                                        </tr>
                                        <tr> 
                                            ...
                                            <td ><?php echo $si_master['amount']?></td>                      
                                        </tr>
                                        <tr> 
                    					...
                    					<tr>
                    						<td height="30px"><label class="control-label">Remark</label></td>
                        ...
                        <div class="panel panel-default table-responsive">
                            ...
                            <table class="table table-bordered" width="100%">
                               ...
                               <?php
                                $i=1;
                                $podata_sql = "SELECT * FROM credit_note_data where ref_no='".$pi_no."'";
      						...
      						<div class="panel-body">
        						<table class="table table-bordered" width="100%">
            						<tbody>
                                        ...
                                        <tr>
                							<td colspan="9" align="center"><input title="Back" type="button" class="btn <?=$btncolor?>" value="Back" onClick="window.location='process_credit_notes.php?from_date=<?=$first_dt?>&to_date=<?=$_REQUEST['challan_date']?><?=$pagenav?>'"></td>
                						</tr>
                					</tbody>
          						</table>
      						</div><!--close panel body-->
						...
						<?php } else { ?>  
   						<div align="center">
                  			<input title="Back" type="button" class="btn <?=$btncolor?>" value="Back" onClick="window.location='process_credit_notes.php?from_date=<?=$first_dt?>&to_date=<?=$_REQUEST['challan_date']?><?=$pagenav?>'">
   						</div>   
   						<?php }?>
                	</div>
             	</form>
