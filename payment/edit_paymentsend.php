...
////// we hit save button
 ...
 if (isset($_POST['upd']) && $_POST['upd']=='Save'){ 
	...
	$flag=dailyActivity($_SESSION['userid'],$docid,"VP","Payment",$ip,$link1,$flag);
	///// check both master and data query are successfully executed
	if ($flag) {
        mysqli_commit($link1);
        $msg = "Payment is edited successfully  with ref. no.".$docid;
    } else {
...
<div class="container-fluid">
  <div class="row content">
    ...
    ?>
    <div class="col-sm-9">
      <h2 align="center"><i class="fa fa-rupee"></i> Edit Payment</h2><br/>
      <div class="form-group"  id="page-wrap" style="margin-left:10px;">
          ...
          <div class="col-md-10"><label class="col-md-3 control-label">To Location<span style="color:#F00">*</span></label>
              <div class="col-md-9">
                  <input type="hidden" name="to_location" id="to_location" class="form-control" value="<?php echo $p_row['to_location'];?>" readonly required/>
                    <input type="text" name="to_location1" id="to_location1" class="form-control" value="<?php echo str_replace("~",",",getVendorDetails($p_row['to_location'],"name,city,state",$link1));?>" readonly required/>
              </div>
            </div>
            </div>
             <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-md-6" id="t_id" style="display:block">
              ...
              <div class="col-md-6">
             <input type="text" name="amount" id="amount" class="form-control number" value="<?php echo $p_row['amount'];?>" required/>
              </div>
              </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
              ...
              <div class="col-md-6">
               <textarea  name="remark" id="remark" class="form-control addressfield"><?php echo $p_row['remark'];?></textarea>
        ...
        <div class="form-group">
            <div class="col-md-12" align="center">
              <input type="submit" class="btn btn-primary" name="upd" id="upd" value="Save" title="Save This Payment">
