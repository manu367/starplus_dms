...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active table-responsive" id="home">
      <h2 align="center"><i class="fa fa-rupee"></i> Receipt List</h2>
      <?php if(isset($_REQUEST['msg']) && $_REQUEST['msg']){?><br>
      <h4 align="center" style="color:#FF0000"><?=$_REQUEST['msg']?></h4>
      <?php }?>
      <form class="form-horizontal" role="form">
        <button title="Add Payment" type="button" class="btn btn-primary" style="float:right;" onClick="window.location.href='payment_receive.php?op=add<?=$pagenav?>'"><span>Add New Receipt</span></button>
      <div class="form-group"  id="page-wrap" style="margin-left:10px;"><br/><br/>
       <table  width="98%" id="myTable" class="table-striped table-bordered table-hover" align="center">
          <thead>
            <tr class="<?=$tableheadcolor?>" >
              ...
              <th data-hide="phone"><a href="#" name="name" title="asc" class="not-sort"></a>Amount</th>
               <th data-hide="phone"><a href="#" name="name" title="asc" class="not-sort"></a>Receipt Date</th>
          ...
          <tbody>
			...
			$sql=mysqli_query($link1,"Select * from payment_receive where to_location in (".$accesslocation.") order by id desc");
