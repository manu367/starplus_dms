...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active table-responsive" id="home">
      <h2 align="center"><i class="fa fa-credit-card"></i> A/C Adjustment</h2>
      <?php if($_REQUEST['msg']!=''){?>
      	<h4 align="center">
        	<span 
      ...
      <form class="form-horizontal" role="form">
        <button title="Add A/C Adjustment" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='acc_adjust.php?op=add<?=$pagenav?>'"><span>Add A/C Adjustment</span></button>
      <div class="form-group"  id="page-wrap" style="margin-left:10px;"><br/><br/>
       <table  width="98%" id="myTable" class="table-striped table-bordered table-hover" align="center">
          ...
          <tbody>
			...
			$sql=mysqli_query($link1,"Select * from payment_receive where to_location in (".$accesslocation.")  and adjustment_type IN ('CR' ,'DR') order by id desc");
            ...
            <tr class="even pointer">
              ...
              <td align="center"><a href='adjustment_details.php?op=view&id=<?php echo base64_encode($row['doc_no']);?><?=$pagenav?>'  title='view'><i class="fa fa-eye fa-lg" title="view details"></i></a></td>
			   <td align="center"><?php if($row['status'] !="PFA"){ ?><a href='../print/print_adjustment.php?rb=view&id=<?php echo base64_encode($row['doc_no']);?><?=$pagenav?>' target="_blank"  title='Print Invoice'><i class="fa fa-print fa-lg" title="Print Invoice"></i></a> <?php }?></td>
            </tr>
            <?php }?>
          </tbody>
          </table>
