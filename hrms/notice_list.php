...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active table-responsive" id="home">
      <h2 align="center"><i class="fa fa-bell"></i> Notice </h2>
     <?php if($_REQUEST['msg']!=''){?>
      	<h4 align="center">
        	<span 
      ...
      <form class="form-horizontal" role="form">
        ...
        <button title="Add Notice" type="button" class="btn <?=$btncolor?>" style="float:right;" onClick="window.location.href='notice_add.php?<?=$pagenav?>'"><i class="fa fa-plus-circle fa-lg" ></i> &nbsp; <span>Add Notice </span></button></div>
       ...
       <table  width="98%" id="myTable" class="table-striped table-bordered table-hover" align="center">
          <thead>
            <tr class="<?=$tableheadcolor?>">
              ...
              <th style="text-align:center;" ><a href="#" name="name" title="asc" ></a>Subject</th>
              <th style="text-align:center;" ><a href="#" name="name" title="asc" ></a>Entry By</th>
              ...
              <th style="text-align:center;" ><a href="#" name="name" title="asc" ></a>Download</th>
              <th style="text-align:center;" data-hide="phone,tablet"><a href="#" name="name" title="asc" class="not-sort"></a>Edit</th>
            </tr>
          </thead>
          <tbody>
            <?php
			...
			$sql=mysqli_query($link1,"Select * from hrms_notice where 1 order by sno desc");
            ...
            <tr class="even pointer">
              ...
              <td align="center"><a href='notice_edit.php?id=<?php echo base64_encode($row['sno']);?><?=$pagenav?>'  title='Edit'><i class="fa fa-edit fa-lg" title="Edit"></i></a></td>
            </tr>
            <?php }?>
          </tbody>
          </table>
