    ...
    <div class="col-sm-9 tab-pane fade in active table-responsive" id="home">
     ...
     <?php if($_REQUEST['msg']!=''){?>
      ...
      <form class="form-horizontal" role="form">
        ...
        <button title="Add Policy" type="button" class="btn <?=$btncolor?>" style="float:right;" onClick="window.location.href='policies_admin_add.php?<?=$pagenav?>'"><i class="fa fa-plus-circle fa-lg" ></i> &nbsp; <span> Add Policy </span></button></div>
