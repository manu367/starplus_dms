    ...
    ?>
      ...
      <form name="frm1" id="frm1" class="form-horizontal" action="" method="post" enctype="multipart/form-data" >
          ...
          <div style="display:inline-block;float:right">
        	<button title="Pay Slip Details Upload" type="button" class="btn <?=$btncolor?>" style="float:right;" onClick="window.location.href='admin_salary_sheet_upload.php?<?=$pagenav?>'"><i class="fa fa-plus-circle fa-upload" ></i> &nbsp; <span>Pay Slip Details Upload</span></button>
          </div>
          <br/><br/>                
                 ...
                 <div class="panel-body">
                 	...
                 	<div class="form-group">
                      <div class="col-md-12" > 
                          ...
                          <div class="col-md-6">
                          	<?php 
								$emp_qry = mysqli_query($link1, " Select username, name from admin_users where 1 order by name ");
							?>
                          	<select id="emp_name" name="emp_name" class="form-control selectpicker required" data-live-search="true" required>
                    ...
                    <div class="form-group" style="text-align:center;">
                    	Print Salary sheet : &nbsp;&nbsp;               
                        <a href='../print/print_salary_sheet.php?rb=view&emp_id=<?php echo base64_encode($_REQUEST['emp_name']);?>&emp_month=<?php echo base64_encode($_REQUEST['emp_month']);?>&emp_year=<?php echo base64_encode($_REQUEST['emp_year']);?><?=$pagenav?>' target="_blank"  title='Print Salary Sheets'>
