...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active table-responsive" id="home">
      <h2 align="center"><i class="fa fa-vcard-o"></i> Designation Master </h2>
     <?php if($_REQUEST['msg']!=''){?>
      	<h4 align="center">
        	<span 
      ...
      <form class="form-horizontal" role="form">
        ...
        <button title="Add Department" type="button" class="btn <?=$btncolor?>" style="float:right;" onClick="window.location.href='designation_add.php?<?=$pagenav?>'"><i class="fa fa-plus-circle fa-lg" ></i> &nbsp; <span>Add Designation </span></button></div>
       ...
       <table  width="98%" id="myTable" class="table-striped table-bordered table-hover" align="center">
          <thead>
            <tr class="<?=$tableheadcolor?>">
              ...
              <th style="text-align:center;"><a href="#" name="name" title="asc" ></a>Designation Name</th>
          ...
          <tbody>
			...
			$sql=mysqli_query($link1,"Select * from hrms_designation_master where 1 order by designationid desc");
            ...
            <tr class="even pointer">
              ...
              <td style="text-align:center;" ><?php echo $row['band']; ?></td>
              ...
              <td align="center"><a href='designation_edit.php?id=<?php echo base64_encode($row['designationid']);?><?=$pagenav?>'  title='Edit'><i class="fa fa-edit fa-lg" title="Edit"></i></a></td>
            </tr>
            <?php }?>
          </tbody>
          </table>
