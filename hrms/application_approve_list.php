...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active table-responsive" id="home">
      <h2 align="center"><i class="fa fa-thumbs-up"></i> Application Approve </h2>
     <?php if($_REQUEST['msg']!=''){?>
      	<h4 align="center">
        	<span 
      ...
      <div class="form-group"  id="page-wrap" style="margin-left:10px;"><br/><br/>
       <table  width="98%" id="myTable" class="table-striped table-bordered table-hover" align="center">
          ...
          <tbody>
			...
			$sql=mysqli_query($link1,"Select * from hrms_request_master where type in ('IR','VR','LR') order by id desc");
            ...
            <tr class="even pointer">
              ...
              <td align="center"><a href='application_approve_view.php?id=<?php echo base64_encode($row['id']);?><?=$pagenav?>'  title='View'><i class="fa fa-eye fa-lg" title="View"></i></a></td>
            </tr>
            <?php }?>
          </tbody>
          </table>
