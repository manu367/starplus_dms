...
if($_POST['submit']=="Save"){
	...
	if(mysqli_num_rows(mysqli_query($link1, "SELECT sno FROM hrms_notice WHERE subject ='".$subject."' or msg = '".$notice_msg."' ")) == 0){
		// insert all details of notice into table //
		$sql = "INSERT INTO hrms_notice set subject ='".$subject."', msg = '".$notice_msg."', entry_date = '".$today."' , file_path = '".$file_path."', emp_id = '".$_SESSION['userid']."', status  = '".$status."'";
	...
	if ($flag) {
		...
		dailyActivity($_SESSION['userid'],$dptid,"NOTICE","ADD",$ip,$link1,"");
      ...
      <form name="frm1" id="frm1" class="form-horizontal" action="" method="post" enctype="multipart/form-data" >
          ...
          <div class="form-group">
            <div class="col-md-12"><label class="col-md-2 control-label">Message <span class="red_small">*</span></label>
              <div class="col-md-8" >
              	<textarea rows="4" name="notice_msg" id="notice_msg" class="form-control required" required> </textarea>			
              </div>
            </div>
          </div>
