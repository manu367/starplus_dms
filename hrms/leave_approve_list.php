...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active table-responsive" id="home">
      <h2 align="center"><i class="fa fa-lightbulb-o"></i> Leave Approve </h2>
     <?php if($_REQUEST['msg']!=''){?>
      	<h4 align="center">
        	<span 
       ...
       <table  width="98%" id="myTable" class="table-striped table-bordered table-hover" align="center">
          ...
          <tbody>
            ...
            <tr class="even pointer">
              ...
              <td align="center"><a href='leave_approved.php?id=<?php echo base64_encode($row['id']);?><?=$pagenav?>'  title='View/Approve'><i class="fa fa-eye fa-lg" title="View/Approve"></i></a></td>
            </tr>
            <?php }?>
          </tbody>
          </table>
