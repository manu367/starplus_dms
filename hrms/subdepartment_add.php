...
if($_POST['submit']=="Save"){
	...
	$getval = explode("~",$department);
	$name = ucwords($sub_department);
	if(mysqli_num_rows(mysqli_query($link1,"select subdeptid from hrms_subdepartment_master where subdept='".$name."' "))==0){
		///////// main queries //////////
		$add_dept="INSERT INTO hrms_subdepartment_master set subdept ='".$name."',departmentid='".$getval[0]."',department='".$getval[1]."' ,status='".$status."',createdate='".date("Y-m-d H:i:s")."',createby='".$_SESSION['userid']."'";
	...
	if ($flag) {
		...
		dailyActivity($_SESSION['userid'],$sdptid,"SUB DEPARTMENT","ADD",$ip,$link1,"");
		
        mysqli_commit($link1);
        $msg = "Sub Department is successfully added.";
		///// move to parent page
...
<div class="container-fluid">
  <div class="row content">
    ...
    ?>
      ...
      <h2 align="center"><i class="fa fa-building-o"></i> Add Sub Department </h2><br><br>
      <form name="frm1" id="frm1" class="form-horizontal" action="" method="post" >
          ...
          <div class="form-group">
              <div class="col-md-12" > 
                ...
                while($row_pro = mysqli_fetch_assoc($res_pro)){?>
                  <option value="<?=$row_pro['departmentid']."~".$row_pro['dname']?>"><?=$row_pro['dname']?></option>
                  <?php } ?>
                </select>
                  </div>    
              </div>  
          ...
          <div class="form-group">
              <div class="col-md-12" > 
                  ...
                  <div class="col-md-6">
                  	<input type="text" name="sub_department" id="sub_department" class="form-control required" required />
                  </div>    
              </div>  
          </div>
