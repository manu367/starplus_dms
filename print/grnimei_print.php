...
$loc=explode('~',getLocationDetails($po_row['to_location'],"phone,addrs,city,state,pan_no,cst_no,st_no,name,gstin_no",$link1));
$to=explode('~',getVendorDetails($po_row['from_location'],"phone,address,city,state,name,gstin_no",$link1));
?>
	  ...
	  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=1>
          ...
          <span class="style9">
              <img src="../img/inner_logo.png" style="float:left;margin-top:5px; ">
                <div style="margin-left:300px;">&nbsp;&nbsp;&nbsp;<?php  echo $loc[7]  ;?><br/>&nbsp;&nbsp;&nbsp;<?php  echo $loc[1]  ;?><br/>&nbsp;&nbsp;&nbsp;</div> </span></TD>
            </TR>
          </TBODY>
        </TABLE>
        <TABLE cellSpacing=0 cellPadding=2 width="100%" border=1>
          <TBODY>
            <TR vAlign=top>
              <TD colspan="2" style="padding-left:5px;"><FONT size=2><B>Ship From(Consignor) :</B><br/><br/><span class="lable">
                <strong><?=$to[4]?><br></strong>
                </span></FONT><BR>
              ...
              <TD colspan="2" vAlign=Top><FONT size=2><B>GRN No.</B>
              &nbsp;&nbsp;<B><?=$po_row['challan_no']?></B></FONT><br>
			  <FONT size=2><B>GRN Date</B>
              &nbsp;<B><?=dt_format($po_row['sale_date'])?></B></FONT><br>
			  <FONT size=2><B>VPO No.</B>
              &nbsp;<B><?=$po_row['ref_no']?></B></FONT><br>
			  <FONT size=2><B>Invoice No.</B>
              &nbsp;<B><?=$po_row['inv_ref_no']?></B></FONT></TD>
            </TR>
            <TR vAlign=top>
              <TD colspan="2" style="padding-left:5px;"><FONT size=2><B>Bill To:</B><BR><BR><B><span class="lable">
               <?=$loc[7]?><br> <?=$loc[6]?>
          ...
          <TBODY>
            <TR>
              <TD width="409" rowspan="7" valign="top" style="padding-left:5px;">
                &nbsp;<FONT size=2>Remarks  : <?=$po_row['receive_remark']?></FONT>
              </TD>
