...
if($po_row['type']=="RETAIL"){
	...
	if($to[0]==""){
		$to=explode('~',getLocationDetails($po_row['po_to'],"phone,addrs,city,state,pan_no,cst_no,st_no,name,gstin_no",$link1));
	}
}else{
    $to=explode('~',getLocationDetails($po_row['po_to'],"phone,addrs,city,state,pan_no,cst_no,st_no,name,gstin_no",$link1));
}
	  ...
	  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=1>
          ...
          <span class="style9">
              <img src="../img/inner_logo.png" style="float:left;margin-top:5px; ">
                <div style="margin-left:300px;">&nbsp;&nbsp;&nbsp;<?php  echo $loc[4]  ;?><br/>&nbsp;&nbsp;&nbsp;<?php  echo $loc[1]  ;?><br/>&nbsp;&nbsp;&nbsp;<?php echo "INVOICE"
;?></div> </span></TD>
            </TR>
          </TBODY>
        </TABLE>
