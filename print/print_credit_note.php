...
$refno = base64_decode($_REQUEST['ref_no']);

$row_qry=mysqli_query($link1,"select * from credit_note where ref_no='$refno'");
...
<TABLE width=800 align="center" cellPadding=0 cellSpacing=0>
  <TBODY>
            ...
            <TR>
              <TD align=right style="border-bottom:none;border-top:none;border-left:none;border-right:none"><strong class="r">CREDIT NOTE</strong></TD>
    ...
    <TR>
      <TD colspan="3" vAlign=top>
        <TABLE cellSpacing='0' cellPadding='1' width="800" border=1>
          <TBODY>
            <TR>
              ...
              <TD width="155" height="28" class="r" style="border-right:none;border-bottom:none;"><b>&nbsp;CR No.</b></TD>
            ...
            <TR>
            <TR>
            	<TD style="border-right:none;border-bottom:none;" class="r"><strong>Status</strong></TD>
                <TD style="border-right:none;border-bottom:none;" class="r"><?=$row['status'];?></TD>
        ...
        <TABLE height=81 cellSpacing=0 cellPadding=0 width="800" border=1>
                    ...
                    <?php
					$i=1;
					$podata_sql = "SELECT * FROM credit_note_data where ref_no='".$refno."'";
        ...
        <TABLE height=177 cellSpacing=0 cellPadding='1' width="800" border=1>
          <TBODY>
            <TR>
              <TD colspan="3"><span class="r">&nbsp;&nbsp;<strong>Amount Credit (In Words):&nbsp;&nbsp; </strong></span>₦<span style="font-size:13px" class="style6 lable">
