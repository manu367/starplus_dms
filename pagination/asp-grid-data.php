...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
        ...
        $viewicon = "<div align='center'><a href='asp_edit.php?op=edit&id=".base64_encode($row['sno'])."".$pagenav."' title='view'><i class='fa fa-eye fa-lg faicon' title='view location details'></i></a></div>";
	...
	////// check if approval is applicable or not
			...
			{
			$nestedData[] = "<div align='center'><a href='approval_location.php?id=".base64_encode($row['sno'])."&status=".$_REQUEST['status']."".$pagenav."' title='Take Action'><i class='fa fa-legal fa-lg faicon' title='Take Action'></i></a></div>";
			}		
			else {
                   $nestedData[] = "<div align='center'><span style='color:black;'>Approved</span></div>";
                  }
