...
//// check serial no. is uploaded or not
    ...
    //START VIEW//
    $view="";
    $view = "<a href='stnDetails.php?id=" . base64_encode($row['challan_no']) . "" . $pagenav . "   title='view'><i class='fa fa-eye fa-lg' title='view details'></i></a>";
    //END VIEW//

    //PRINT//
    $print="";
    $print = "<a href='../print/print_stn.php?rb=view&id=" . base64_encode($row['challan_no']) . "" . $pagenav . "  target='_blank' title='Print PO'><i class='fa fa-print fa-lg' title='Print PO'></i></a>";
    //PRINT//
