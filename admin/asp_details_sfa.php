...
$(document).ready(function() {
	var dataTable = $('#myTable').DataTable( {
		...
		"order": [[ 1, "asc" ]],
		"ajax":{
			url :"../pagination/asp-sfa-grid-data.php", // json datasource
...
<div class="container-fluid">
  <div class="row content">
	...
	<div class="<?=$screenwidth?> tab-pane fade in active" id="home">
        <h2 align="center"><i class="fa fa-bank"></i> Customer/Locations (SFA) Master</h2>
	    <?php if($_REQUEST['msg']){?>
	    <br>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-6">
       		<button title="Add New Customer/Location" type="button" class="btn <?=$btncolor?>" style="float:right;margin-bottom:20px" onClick="window.location.href='asp_add_sfa.php?op=add<?=$pagenav?>'"><span>Add New Customer/Location</span></button>
        </div>
      </div>
	  </form>
