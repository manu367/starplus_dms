...
if(isset($_REQUEST['nature'])){$nature=$_REQUEST['nature'];}else{$nature="";}
...
$(document).ready(function() {
	var dataTable = $('#account-grid').DataTable( {
		...
		"order":  [[0,"asc"]],
		"ajax":{
			url :"../pagination/account-grid-data.php", // json datasource
			data: { "pid": "<?=$_REQUEST['pid']?>", "hid": "<?=$_REQUEST['hid']?>", "icn": "<?=$_REQUEST['icn']?>", "status": "<?=$selstatus?>", "nature": "<?=$nature?>", "acgroup": "<?=$selgroup?>"},
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-bandcamp"></i> Account Head Master</h2>
	  ...
	  <div class="row">
      	<div class="col-sm-3 col-md-3 col-lg-3"><label class="col-md-6">Nature</label>
        	<select name="nature" id="nature"  class="form-control">
                <option value="" <?php if($_REQUEST['nature']==''){ echo "selected";}?>>All</option>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-6">
            <button title="Add New Account" type="button" class="btn<?=$btncolor?>" style="float:right;margin-bottom:20px" onClick="window.location.href='add_account_head.php?op=add<?=$pagenav?>'"><i class="fa fa-plus-circle fa-lg"></i>&nbsp;&nbsp;Add New</button>
        </div>
      </div>
	  </form>
