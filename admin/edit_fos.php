...
$upload3=$iden_n;	
   ...
   //echo "Update fos_master set name='".$fos_name."',contact_no='".$contact."',dob='".$fdate."',email='".$email."',local_add='".$local_address."',per_add='".$per_address."',state='".$state."',doj='".$tdate."',f_type='".$type."',holder_name='".$account."',acc_no='".$acc_no."',br_add='".$branch_addr."',br_name='".$branch."',fos_file='".$upload1."',cheque_file='".$upload2."',identity_file='".$upload3."',identity='".$mode."',acknowledge='".$terms."',updatedate='$datetime' where id='$getid'  ";
   $sql=mysqli_query($link1,"Update fos_master set name='".$fos_name."',contact_no='".$contact."',dob='".$fdate."',email='".$email."',local_add='".$local_address."',per_add='".$per_address."',state='".$state."',doj='".$tdate."',f_type='".$type."',holder_name='".$account."',acc_no='".$acc_no."',br_add='".$branch_addr."',br_name='".$branch."',fos_file='".$upload1."',cheque_file='".$upload2."',identity_file='".$upload3."',identity='".$mode."',acknowledge='".$terms."',updatedate='$datetime' where id='$getid' ")or die("ER4".mysqli_error($link1)); 
   if($sql)
     {
	   $usr_add=mysqli_query($link1,"update admin_users set name= '".$fos_name."',utype='FOS',phone='".$contact."',emailid= '".$email."',updatedate='".date("Y-m-d H:i:s")."' where username = '".$user."'");
     }
...
else
{
	   ...
	   $sql=mysqli_query($link1,"UPDATE fos_master set name='".$fos_name."',contact_no='".$contact."',dob='".$fdate."',email='".$email."',local_add='".$local_address."',per_add='".$per_address."',state='".$state."',doj='".$tdate."',f_type='".$type."',holder_name='".$account."',acc_no='".$acc_no."',br_add='".$branch_addr."',br_name='".$branch."',ifsc_code='".$ifsc."',fos_file='".$row['fos_file']."',cheque_file='".$row['cheque_file']."',identity_file='".$row['identity_file']."',identity='".$mode."',acknowledge='".$terms."',updatedate='$datetime' where id='$getid' ")or die("ER4".mysqli_error($link1)); 
     if($sql)
     {
	   $usr_add=mysqli_query($link1,"update admin_users set name= '".$fos_name."',utype='FOS',phone='".$contact."',emailid= '".$email."',updatedate='".date("Y-m-d H:i:s")."' where username = '".$user."'");
     }
		  ...
		  <div class="form-group">
            ...
            <div class="col-md-6">
               ...
               <?php if($row['fos_file']!=''){?> <div id="inline1" ><img src="<?php echo $row['fos_file'];?>" height="50px" width="100px"  /></div>   <?php }?> 
												 ...
												 <input type="hidden" name="fos_pho" id="fos_pho" value="<?php echo  $row['fos_file'];?>">  
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
                                               ...
                                               (2MB) <?php if($row['cheque_file']!=''){?><div id="inline" ><img src="<?php echo $row['cheque_file'];?>" height="50px" width="100px"  /></div><?php } ?>
												...
												<input type="hidden" name="ifs" id="ifs" value="<?php echo $row['cheque_file'];?>">  	
          </div>
		  <div class="form-group">
			  <div class="col-md-6">
									...
									<div class="col-md-6">
                                              ...
                                              <?php if($row['identity_file']!=''){?> <div id="inline2" ><img src="<?php echo $row['identity_file'];?>" height="50px" width="100px"  /></div> <?php } ?>
												...
												<input type="hidden" name="iden_n" id="iden_n" value="<?php echo $row['identity_file'];?>"> 
