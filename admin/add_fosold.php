...
if($up1 || $up2 || $up3)
{
	...
	$sql=mysqli_query($link1,"insert into fos_master set name='".$fos_name."',contact_no='".$contact."',dob='".$fdate."',email='".$email."',local_add='".$local_address."',per_add='".$per_address."',state='".$state."',doj='".$tdate."',f_type='".$type."',holder_name='".$account."',acc_no='".$acc_no."',br_add='".$branch_addr."',br_name='".$branch."',ifsc_code='".$ifsc."',fos_file='".$path1."',cheque_file='".$path."',identity_file='".$path2."',identity='".$mode."',acknowledge='".$terms."',status='Active',entry_date='$datetime',entry_by='$_SESSION[userid]' ")or die("ER4".mysqli_error($link1)); 
...
else
{
	   ...
	   $sql=mysqli_query($link1,"insert into fos_master set name='".$fos_name."',contact_no='".$contact."',dob='".$fdate."',email='".$email."',local_add='".$local_address."',per_add='".$per_address."',state='".$state."',doj='".$tdate."',f_type='".$type."',holder_name='".$account."',acc_no='".$acc_no."',br_add='".$branch_addr."',br_name='".$branch."',ifsc_code='".$ifsc."',identity='".$mode."',acknowledge='".$terms."',status='Active',entry_date='$datetime',entry_by='$_SESSION[userid]' ")or die("ER4".mysqli_error($link1)); 
