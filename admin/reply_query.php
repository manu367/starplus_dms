...
$sql=mysqli_query($link1,"update query_master set solution='".$solution."',status='closed',update_date='$date',update_by='$_SESSION[userid]' where id='".$getid."'")or die("ER4".mysqli_error($link1)); 
   
 
 ////// insert in activity table////
	dailyActivity($_SESSION['userid'],$row['module'],"QUERY","UPDATE",$ip,$link1);
    //return message
	$msg="You have successfully updated Query with module ".$row['module']." ";
	///// move to parent page
...
<div class="container-fluid">
  <div class="row content">
    ...
    ?>
    <div class="col-sm-9">
      <h2 align="center"><i class="fa fa-book"></i>&nbsp;&nbsp;Reply Query</h2><br/><br/>
         ...
         <div class="form-group">
		  ...
		  <div class="col-md-6"><label class="col-md-6 control-label">Contact Number<span class="red_small">*</span></label>
			 ...
			 <div class="col-md-6"><label class="col-md-6 control-label">Solution<span class="red_small">*</span></label>
              <div class="col-md-6">
                <textarea name="solution" id="solution" class="form-control required"  required onkeypress = " return ( (event.keyCode ? event.keyCode : event.which ? event.which : event.charCode)!= 13);"  onContextMenu="return false" style="resize:vertical"><?php echo $row['solution']; ?></textarea>
              </div>
            </div>
			</div>
          <div class="form-group">
            <div class="col-md-12" align="center">
              ...
              <input type="submit" class="btn btn-primary" name="Submit" id="" value="Save" title="">
