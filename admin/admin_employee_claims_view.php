      ...
      <form name="frm1" id="frm1" class="form-horizontal" action="" method="post" >
                 ...
                 <div class="panel-body">
                  ...
                  <table width="100%" id="itemsTable1" class="table table-bordered table-hover">
                    ...
                    <tbody>
					  ...
					  ?>
                      <tr>
                      	<td colspan="6" style="text-align:right; font-weight: 800; font-size:13px;">
                     ...
                     <div class="panel-body">
                      ...
                      <table width="100%" id="lodgingitemsTable" class="table table-bordered table-hover">
                        ...
                        <tbody>
						  ...
						  ?>
						  <tr>
							<td colspan="4" style="text-align:right; font-weight: 800; font-size:13px;">
          ...
          <div class="form-group">
              <div class="col-md-12" style="text-align:center;" > 
                  <input title="Back" type="button" class="btn  <?=$btncolor?>" value="Back" onclick="window.location.href='hr_related_status.php?id=<?=base64_encode($userid);?>&user=<?=base64_encode($userid);?><?=$pagenav?>'">
              </div>  
          </div>
          <br><br>
      </form>                      
