...
$expl_pc = explode("~",$_REQUEST['category']);
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="container-fluid">
    	...
    	?>
    		<div class="col-sm-9">
      			<h2 align="center"><i class="fa fa-book"></i>&nbsp;&nbsp;Add New Catalog</h2><br/>
          		...
          		<form  name="frm1"  id="frm1"  class="form-horizontal" action="" method="post" enctype="multipart/form-data">
            			...
            			<div class="col-md-10"><label class="col-md-4 control-label">Category<span class="red_small">*</span></label>
              				<div class="col-md-6">
                 				<select name="category"  id= "category" class="form-control selectpicker required" onChange="document.frm1.submit();" required>
                                    ...
                                    ?>
                                    <option value="<?=$row_pcat['catid']."~".$row_pcat['cat_name']?>" <?php if($_REQUEST['category'] == $row_pcat['catid']."~".$row_pcat['cat_name']) { echo "selected" ;}?>><?=$row_pcat['cat_name']?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                    ...
                    <div class="form-group">
            			<div class="col-md-10"><label class="col-md-4 control-label">Catalog Name<span class="red_small">*</span></label>
              				<div class="col-md-6">
                 				<input type="text" name="catalog_name" class="form-control required mastername" id="catalog_name" required/>
              				</div>
            			</div>
          			</div>
                    <div class="form-group">
            			<div class="col-md-10"><label class="col-md-4 control-label">Catalog Description</label>
              				<div class="col-md-6">
                 				<textarea name="catalog_desc" id="catalog_desc" style="resize:none" class="form-control addressfield"></textarea>
              				</div>
            			</div>
          			</div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <table class="table table-bordered" width="75%" id="itemsTable3">
                                ...
                                <tbody>
                                    <tr id="addr_doc0">
                                        <td>
                                        <select name="psubcategory[0]"  id= "psubcategory[0]" class="form-control selectpicker required" data-live-search="true" required onChange="checkDuplicate(0, this.value)">
                                            <option value="">--Please Select--</option>
                                            <?php
                                            $pcat=mysqli_query($link1,"Select *  from product_sub_category where status = '1'  and productid = '".$expl_pc[0]."' ");
                                            while($row_pcat=mysqli_fetch_array($pcat)){
                                            ?>
                                            <option value="<?=$row_pcat['psubcatid']."~".$row_pcat['prod_sub_cat']?>"><?=$row_pcat['prod_sub_cat']?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                                        ...
                                        <td>
                                            ...
                                            <input type="file" class="required" id="browse0" name="fileupload0" style="display: none" onChange="Handlechange(0);" accept="image/*"/>
