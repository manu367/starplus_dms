...
$(document).ready(function() {
	var dataTable = $('#product-grid').DataTable( {
		...
		"order": [[ 1, "asc" ]],
		"ajax":{
			url :"../pagination/segment-grid-data.php", // json datasource
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?>">
      <h2 align="center"><i class=" fa fa-suitcase fa-lg"></i> Segment Master </h2>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-6">
        	<button title="Add New Segment" type="button" class="btn <?=$btncolor?>"  style="float:right;margin-bottom:20px" onClick="window.location.href='add_segment.php?op=Add<?=$pagenav?>'"><i class="fa fa-plus-circle fa-lg"></i>&nbsp;&nbsp;Add New Segment</button>
        </div>
      </div>
	  </form>
