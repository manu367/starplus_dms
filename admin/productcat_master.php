...
$(document).ready(function() {
	var dataTable = $('#product-grid').DataTable( {
		...
		"order": [[ 1, "asc" ]],
		"ajax":{
			url :"../pagination/product-grid-data.php", // json datasource
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?>">
      <h2 align="center"><i class=" fa fa-suitcase fa-lg"></i> Product Category </h2>
      ...
      <div class="row">
      	<div class="col-sm-6 col-md-6 col-lg-6">
        	<?php
			   ...
			   ?>
               <a href="excelexport.php?rname=<?=base64_encode("productcatmaster")?>&rheader=<?=base64_encode("Product Cat Master")?>&status=<?=base64_encode($selstatus)?>" title="Export product category details in excel"><i class="fa fa-file-excel-o fa-2x" title="Export product category details in excel"></i></a>
               <?php
				//}
			//}
				?>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6">
        	<button title="Add New Category" type="button" class="btn <?=$btncolor?>"  style="float:right;margin-bottom:20px" onClick="window.location.href='add_product.php?op=Add<?=$pagenav?>'"><i class="fa fa-plus-circle fa-lg"></i>&nbsp;&nbsp;Add New Category</button>
        </div>
      </div>
	  </form>
