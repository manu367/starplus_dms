                ...
                <div class="panel panel-default">
                    ...
                    <span class="badge rounded-pill
                        ...
                        <?= htmlspecialchars($row['status']) ?>
                                ...
                                <!-- Remark -->
                                <td style="white-space: pre-line; align-content: center;text-align: center" >
                                    <?= !empty($row['remark'])
                                            ? htmlspecialchars($row['remark'])
                                            : '<span class="text-muted fst-italic ">No remark available</span>' ?>
                                </td>

                                <!-- Approved By -->
                                <td class="text-center">
                                    <?= htmlspecialchars($row['approve_by'] ?: 'System') ?>
                                </td>
