...
print("\n");
////// filters value/////
$feedbackby = base64_decode($_REQUEST['feedback_by']);
$feedbacktype = base64_decode($_REQUEST['feedback_type']);
...
if($feedbackby !=''){
	$filter_str	.= " AND a.entry_by = '".$feedbackby."'";
}
if($feedbacktype !=''){
	$filter_str	.= " AND a.problem = '".$feedbacktype."'";
}
if($department){
...
<table width="100%" border="1" cellpadding="2" cellspacing="1" bordercolor="#000000">
    ...
    while ($row = mysqli_fetch_assoc($sql)) {
        ...
        <tr>
            ...
            <td><?=$row['entry_date']." ".$row['entry_time'];?></td>
            <td><?=$row['address']; ?></td> 
        </tr>
        <?php
        $i+=1;
