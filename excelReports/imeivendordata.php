...
<?php
$i=1;
$sql=mysqli_query($link1,"Select * from billing_imei_data a inner join billing_master b on a.doc_no=b.challan_no where $from_party and $to_party  and $sql_date and $product_code")or die("er1".mysqli_error($link1));
