...
//////End filters value/////
$sqldata = "SELECT a.*, b.name, b.oth_empid, b.designationid, b.department, b.subdepartment FROM user_attendence a, admin_users b WHERE 1=1 AND a.user_id=b.username ".$subdeptqry." ".$deptqry." ".$user_id;
if ($fromdate != '' || $todate != '') {
