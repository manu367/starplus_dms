...
////// pick max no. of Customer
  ...
  $sql="INSERT INTO customer_master set customerid='".$newcustomercode."',tempid='".$code_id."',customername='".$_REQUEST[name]."',address='".$address."',city='".$city."',state='".$state."',country='".$country."',contactno='".$_REQUEST[phone]."',emailid='".$_REQUEST[email]."',status='Active',mapplocation='".$location."',createby='".$_SESSION['userid']."',createdate='".$today."',category='RETAIL'";
   ...
   ////// insert in activity table////
	...
	if ($flag) {
        $msg = "Customer is successfully created with ID. ".$newcustomercode;
    }else{
		$msg = "Request could not be processed.".$err_msg;
	}
	
	header("Location:customerbilling.php?msg=".$msg."".$pagenav);
	exit;
}
}
?>
...
<div class="container-fluid">
  <div class="row content">
    ...
    ?>
    <div class="col-sm-9">
      <h2 align="center"><i class="fa fa-plus-square-o"></i> Add Customer</h2><br/><br/>
      ...
      <div class="form-group"  id="page-wrap" style="margin-left:10px;" >
		  ...
		  <div class="form-group">
			...
			<div class="col-md-6"><label class="col-md-4 control-label">Address<span class="red_small">*</span></label>
              <div class="col-md-7">
				  <textarea name="address" id="address" class="form-control" required row="6"></textarea>
              </div>
            </div>   
          </div> 
          ...
          <div class="form-group">
            <div class="col-md-12" align="center">
              ...
              <input title="Back" type="button" class="btn btn-primary" value="Back" onClick="window.location.href='customerbilling.php?<?= $pagenav ?>'">
            </div>
          </div>
    </form>
      </div>
