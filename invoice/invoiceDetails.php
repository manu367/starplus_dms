       ...
       <table class="table table-bordered" width="100%">
			...
			?>
              <tr>
                ...
                <td style="text-align:left"><?php if($invdata_row['scheme_name']!=""){ echo $invdata_row['scheme_name']; }else{ echo ""; } ?></td>
                <td style="text-align:left"><?php if($invdata_row['scheme_code']!=""){ echo $invdata_row['scheme_code']; }else{ echo ""; } ?></td>
              </tr>
            <?php
