...
@extract($_GET);
///// get data 
$res_sh=mysqli_query($link1,"select count(prod_code) as qty , prod_code from temp_bill_upload where update_by='".$_SESSION['userid']."' and browserid='".$browserid."' and file_id='".$_REQUEST['file_id']."' and  flag='' group by prod_code");
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active" id="home">
      ...
      <form class="form-horizontal" role="form" name="frm2" id="frm2" action="processbillupld.php" method="post" onSubmit="hideButton();">
      <div class="form-group">
            <div class="col-md-12" align="center">
               ...
               <input name="taxD" id="taxD" type="hidden" value="<?=$tax?>"/>
