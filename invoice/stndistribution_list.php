...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active table-responsive" id="home">
      <h2 align="center"><i class="fa fa-bars"></i> STN Distribution List</h2>
      <?php if($_REQUEST[msg]){?><br>
      <h4 align="center" style="color:#FF0000"><?=$_REQUEST[msg]?></h4>
      <?php }?>
      <form class="form-horizontal" role="form">
        <button title="Add New Stock Transfer" type="button" class="btn <?=$btncolor?>" style="float:right;" onClick="window.location.href='addstnDistribution.php?op=add<?=$pagenav?>'"><span>Add STN Distribution</span></button>
      <div class="form-group"  id="page-wrap" style="margin-left:10px;"><br/><br/>
       <table  width="98%" id="myTable" class="table-striped table-bordered table-hover" align="center">
          ...
          <tbody>
			...
			$sno=0;
			///// get access location ///
			$sql=mysqli_query($link1,"Select * from billing_master where from_location = '".$_SESSION['owner_code']."' and type = 'STN Distribution' order by id desc");
            ...
            <tr class="even pointer">
			  ...
			  <td align="center"><a href='stndistributionDetails.php?id=<?php echo base64_encode($row['challan_no']);?><?=$pagenav?>'  title='view'><i class="fa fa-eye fa-lg" title="view details"></i></a></td>
