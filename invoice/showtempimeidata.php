    ...
    <div class="col-sm-9 tab-pane fade in active" id="home">
      ...
      <form class="form-horizontal table-responsive" role="form" name="frm1" id="frm1">
       <table  width="99%" id="myTable" class="table-striped table-bordered table-hover" align="center">
          <thead>
            <tr>
              <th width="14%"><a href="#" name="entity_id" title="asc" ></a>S.No</th>
              <th width="23%" data-class="expand"><a href="#" name="entity_id" title="asc" ></a>Product</th>
              <th width="20%"><a href="#" name="name" title="asc" ></a>Uploaded Qty</th>
              <th width="23%">Invoice Product</th>
          ...
          <tbody>
			...
			while($row=mysqli_fetch_assoc($res_sh)){
				  ...
				  $invprd=mysqli_fetch_assoc(mysqli_query($link1,"select prod_code,SUM(qty) AS qty from billing_model_data where challan_no='".$_REQUEST['inv_no']."' and prod_code='".$row['prod_code']."' AND prod_cat!='C'"));
			?>
            <tr class="even pointer">
              ...
              <td align="center"><?php if($invprd['prod_code']){ echo "<i class='fa fa-check-circle fa-lg'></i>"; $flag2*=1;}else{ echo "Upload wrong product"; $flag2*=0;}?></td>
      ...
      <form class="form-horizontal" role="form" name="frm2" id="frm2" action="processimeilupld.php" method="post" onSubmit="hideButton();">
