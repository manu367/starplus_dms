...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active table-responsive" id="home">
      <h2 align="center"><i class="fa fa-reply"></i> Stock Transfer Approval</h2>
       ...
       <table  width="98%" id="myTable" class="table-striped table-bordered table-hover" align="center">
          ...
          <tbody>
            ...
            <tr class="even pointer">
              ...
              <td align="center"><a href='stockTransferApprovalPageN.php?op=app&id=<?php echo base64_encode($row['challan_no']);?><?=$pagenav?>'  title='view'><i class="fa fa-eye fa-lg" title="view details"></i></a></td>
              <td align="center"><?php if($row['status']=="PFA"){?><a href='editstnDetails.php?op=edit&id=<?php echo base64_encode($row['challan_no']);?><?=$pagenav?>'  title='edit'><i class="fa fa-pencil fa-lg" title="edit details"></i></a><?php }?></td>
            </tr>
            <?php }?>
          </tbody>
          </table>
