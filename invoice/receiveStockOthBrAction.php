...
$po_sql="SELECT * FROM billing_master WHERE challan_no='".$docid."' AND type NOT IN ('PURCHASE RETURN')";
               				...
               				<tr>
                 				<td colspan="4" align="center">
                    				...
                    				<input name="refno" id="refno" type="hidden" value="<?=base64_encode($po_row['challan_no'])?>"/>
                 					...
                 					<input title="Back" type="button" class="btn<?=$btncolor?>" value="Back" onClick="window.location.href='receive_stock_oth_br.php?<?=$pagenav?>'"></td>
                			</tr>
            			</tbody>
          			</table>
      			</div><!--close panel body-->
