...
if ($_POST['upd']=='Save'){
		...
		{   	    
			...
			if($prod_code[$k]!='' && $req_qty[$k]!='' && $req_qty[$k]!=0){
				...
				$prodcat=getProductDetails($prod_code[$k],"productcategory",$link1);
		     	$query2 = "insert into billing_model_data set from_location='".$partycode. "',challan_no='" . $invno . "', prod_code='" .$prod_code[$k]. "',prod_cat='" . $prodcat . "', qty='" .$req_qty[$k] . "', mrp='" .$price[$k]. "', price='" .$price[$k]. "', value='" . $linetotal[$k] . "',discount='" .$rowdiscount[$k] . "',sgst_per='" . $sgst_per[$k]. "',sgst_amt='" .$sgst_amt[$k] . "',cgst_per='" .$cgst_per[$k]. "',cgst_amt='" .$cgst_amt[$k]. "',igst_per='" .$igst_per[$k]. "',igst_amt='" .$igst_amt[$k] . "', totalvalue='" . $total_val[$k] . "',sale_date='" . $today . "',entry_date='" . $today . "', disc_amt = '".$rowdiscount_val[$k]."' ";	
	...
	///// Insert Master Data
    $query1 = "INSERT INTO billing_master set from_location='".$partycode . "',to_location='" . $parentcode . "',challan_no='" . $invno . "',sale_date='" . $today . "',entry_date='" . $today . "',entry_time='" . $currtime . "',type='STN',document_type='".$doctype."',status='PFA',entry_by='" . $_SESSION['userid'] . "',basic_cost='" . $sub_total . "',discount_amt='" . $total_discount . "',tax_cost='" .$tax_amount . "',total_sgst_amt='" . $totalsgst_amt . "',total_cgst_amt='" . $totalcgst_amt . "',total_igst_amt='" . $totaligst_amt . "',total_cost='" . $grand_total . "',bill_from='".$partycode. "',bill_topty='".$parentcode. "',from_addrs='" .$from_addr[0] . "',disp_addrs='" .$from_addr[0] . "',to_addrs='" .$to_addr[0]. "',deliv_addrs='" . $delivery_address . "',billing_rmk='" . $remark . "' ";	
...
/////////// function to get available stock of ho
  ...
  function getAvlStk(indx){
	  ...
	  $.ajax({
		...
		data:{locstknew:productCode,loccode:locationCode,fromloc:locationCodefrom,stktype:stocktype,indxx:indx},
              ...
              <div class="col-md-7">
                 ...
                 <option value="" selected="selected">Please Select </option>
                    ...
                    <?php 
					 ...
					 $sql_parent="select mapped_code,uid from mapped_master where uid='" . $_REQUEST['stock_from'] . "' and status='Y' AND (mapped_code LIKE 'EABR%' OR mapped_code LIKE 'DEHO%')";
          ...
          <table width="100%" id="itemsTable1" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id='addr0'>
                ...
                <td class="col-md-1"><input type="text" class="form-control digits" name="req_qty[0]" id="req_qty[0]"  style="width:40px;" autocomplete="off" required onBlur="myFunction(this.value,0,'req_qty');rowTotal(0);" onKeyPress="return onlyNumbers(this.value);"></td>

                <td class="col-md-2"><input type="text" class="form-control" name="price[0]" id="price[0]" style="width:60px;" autocomplete="off" onKeyPress="return onlyFloatNum(this.value);" onBlur="rowTotal(0);" required></td>

                <td class="col-md-2"><input type="text" class="form-control" name="linetotal[0]" id="linetotal[0]" autocomplete="off"  style="width:60px;" readonly></td>
			  ...
			  <td class="col-md-1"><input type="text" class="form-control" name="rowdiscount_val[0]" id="rowdiscount_val[0]" onKeyPress="return onlyFloatNum(this.value);" autocomplete="off" ></td>	
			  
			   <td class="col-md-1"><input type="text" class="form-control" name="sgst_per[0]" id="sgst_per[0]" onKeyPress="return onlyFloatNum(this.value);" autocomplete="off" readonly style="width:50px;" ></td>
			   
			   <td class="col-md-1"><input type="text" class="form-control" name="sgst_amt[0]" id="sgst_amt[0]" onKeyPress="return onlyFloatNum(this.value);" autocomplete="off" readonly style="width:50px;"></td>	
			   
			   <td class="col-md-1"><input type="text" class="form-control" name="cgst_per[0]" id="cgst_per[0]" onKeyPress="return onlyFloatNum(this.value);" autocomplete="off" readonly style="width:50px;"></td>
			   
			   <td class="col-md-1"><input type="text" class="form-control" name="cgst_amt[0]" id="cgst_amt[0]" onKeyPress="return onlyFloatNum(this.value);" autocomplete="off" readonly style="width:50px;"></td>
			   
			    <td class="col-md-1"><input type="text" class="form-control" name="igst_per[0]" id="igst_per[0]" onKeyPress="return onlyFloatNum(this.value);" autocomplete="off" readonly style="width:50px;"></td>
			   
			   <td class="col-md-1"><input type="text" class="form-control" name="igst_amt[0]" id="igst_amt[0]" onKeyPress="return onlyFloatNum(this.value);" autocomplete="off" readonly style="width:50px;"></td>	
			   
			   
				
                <td class="col-md-2"><input type="text" class="form-control" name="total_val[0]" id="total_val[0]" autocomplete="off"  style="width:80px;"readonly>
...
<td class="col-md-1"><input type="text" class="form-control" name="avl_stock[0]" id="avl_stock[0]"  autocomplete="off" style="width:50px;text-align: right;padding: 4px;" value="0" readonly></td>	
