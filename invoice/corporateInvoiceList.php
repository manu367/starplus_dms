<?php
////// Function ID ///////
$fun_id = array("u"=>array(127,121)); // User:
...
$(document).ready(function() {
	var dataTable = $('#invoice_grid').DataTable( {
		"processing": true,
		"serverSide": true,
		"bStateSave": true,
		"order":  [[5,"desc"]],
		"ajax":{
			url :"../pagination/corporateInvoice_grid_data.php", // json datasource
			...
			error: function(){  // error handling
				$(".invoice_grid_error").html("");
				$("#invoice_grid").append('<tbody class="invoice_grid_error"><tr><th colspan="13">No data found in the server</th></tr></tbody>');
				$("#invoice_grid_processing").css("display","none");
			}
		}
	});
});
            ...
            <form class="form-horizontal" role="form" name="frm1" action="" method="POST">
      		...
      		<form class="form-horizontal" role="form">
      			<div class="form-group"  id="page-wrap" style="margin-left:10px;"><br/><br/>
       				<table width="98%" id="invoice_grid" class="table-striped table-bordered table-hover" align="center">
          				<thead>
