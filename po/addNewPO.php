...
if($_POST){
 ...
 if ($_POST['upd']=='Save'){
	...
	//include("../erpapi/postSalesOrder.php");
	...
	/*if(substr($partycode,0,4)=="EADL"){
		...
		$flag = approvalActivity($po_no,$today,"PO",$_SESSION['userid'],$actiontaken,$today,$currtime,"AUTO APPROVED",$ip,$link1,$flag);
		////// insert in activity table////
		$flag = dailyActivity($_SESSION['userid'],$po_no,"PO APPROVAL","APPROVAL",$ip,$link1,$flag);
	}*/
