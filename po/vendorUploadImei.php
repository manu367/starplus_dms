	      ...
	      if($r[0]=='' && $r[2]==''){
	     	 ...
	     	 ////Make Variable for each element of excel//////		
					$imei1="".$r[0];
				  	//$imei2="".$r[1];
					$stocktype="".$r[2];
                    $froml = $vendor_master['po_from'];
                    $tol = $vendor_master['po_to'];
                    $owner_no = $vendor_master['po_to'];
				...
				$imeidata = mysqli_fetch_assoc(mysqli_query($link1,"select id from billing_imei_data where imei1='" .$imei1. "' "));
					...
					if ($imeidata['id'] != "") {
                       $msg_imei = "Serial No. is Already Uploaded";
                       header("Location:vpoDetails.php?op=edit&id='".base64_encode($_POST['po_no'])."'&msg=$msg_imei" . $pagenav);
                       exit; 
                    } 
        ...
        if ($msg == '1') {
		  ...
		  if($status['vid']  == $po_no['vid'])
		  {
		    $result4  =  mysqli_query($link1, "update vendor_order_master set file_name='" . $f_name . "',imei_attach='Y' , upload_date = '".$today."'  where po_no='" . $_POST['po_no'] . "'   ");
             ...
             header("Location:vpoDetails.php?op=edit&id='".base64_encode($_POST['po_no'])."'&msg=$msg" . $pagenav);
                exit;
            } else {
        ...
        <div class="container-fluid">
            <div class="row content">
                ...
                <div class="col-sm-9 tab-pane fade in active" id="home">
                    <h2 align="center"><i class="fa fa-upload"></i> Upload<?=$imeitag?></h2><div style="display:inline-block;float:right"><a href="../templates/Vendor_imei.xlsx" title="Download Excel Template"><img src="../img/template.png" title="Download Excel Template"/></a></div><br/>
                        ...
                        <form  name="frm1"  id="frm1" class="form-horizontal" action="" method="post"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="col-md-12" align="center">
                                    <input title="Back" class="btn<?=$btncolor?>" value="Back" onClick="window.location.href = 'vpoDetails.php?op=edit&id=<?=base64_encode($_GET['po_no'])?><?= $pagenav ?>'" type="button">&nbsp;&nbsp;&nbsp;
