...
if ($_POST) {
    if ($_POST['upd'] == 'Save') {
        ...
        //// Make System generated PO no.//////
      	...
      	$c_nos = $row_po[no]+1;
       $po_no = $parentcode . "PO" . $c_nos;
        mysqli_autocommit($link1, false);
        $flag = true;
	
        ///// Insert Master Data
       $query1 = "INSERT INTO vendor_order_master set po_to='" . $parentcode . "',po_from='" . $partycode . "',po_no='" . $po_no . "',temp_no='" . $c_nos . "',ref_no='" . $ref_no . "',requested_date='" . $today . "',entry_date='" . $today . "',entry_time ='" . $currtime . "',req_type='VPO',status='Pending',po_value='" . $sub_total . "',create_by='" . $_SESSION['userid'] . "',ip='" . $ip . "',taxtype='" . $tax_type . "',taxper='" . $tax_per . "',taxamount='" . $tax_total . "',currency_type='" . $currency_type . "',invoice_no='" . $invoiceno . "',invoice_date='" . $invoicedate . "',remark='" . $remark . "',delivery_address='" . $delivery_address . "',round_off='" . $round_off . "',total_sgst_amt='" . $tot_sgst_amt . "',total_cgst_amt='" . $tot_cgst_amt . "',total_igst_amt='" . $tot_igst_amt . "',total_amt='" . $grand_total . "'";
    ...
    ?><option data-tokens="<?php echo $br['productname']; ?>" value="<?php echo $br['productcode']; ?>"><?= $br['productname'] . ' | ' . $br['productcolor'] . ' | ' . $br['productcode']; ?></option><?php } ?></select></span></td><td><input type="text" name="req_qty[' + num + ']" id="req_qty[' + num + ']" onblur=rowTotal(' + num + ');myFunction(this.value,' + num + ',"req_qty"); class="digits form-control" value="0" onkeypress="return onlyNumbers(this.value);" style="text-align: right;padding: 4px;"/></td><td><input  name="price[' + num + ']" id="price[' + num + ']" type="text" onkeypress="return onlyFloatNum(this.value)" value="0.00" class="form-control" onblur="rowTotal(' + num + ');" style="text-align: right;padding: 4px;"></td><td><input type="text" name="value[' + num + ']" id="value[' + num + ']" class="form-control" value="0.00" readonly style="text-align: right;padding: 4px;"/></td><td><input type="text" name="sgst_per[' + num + ']" id="sgst_per[' + num + ']" class="form-control" value="0.00" readonly style="text-align: right;padding: 4px;"/></td><td><input type="text" name="sgst_amt[' + num + ']" id="sgst_amt[' + num + ']" class="form-control" value="0.00" readonly style="text-align: right;padding: 4px;"/></td><td><input type="text" name="cgst_per[' + num + ']" id="cgst_per[' + num + ']" class="form-control" value="0.00" readonly style="text-align: right;padding: 4px;"/></td><td><input type="text" name="cgst_amt[' + num + ']" id="cgst_amt[' + num + ']" class="form-control" value="0.00" readonly style="text-align: right;padding: 4px;"/></td><td><input type="text" name="igst_per[' + num + ']" id="igst_per[' + num + ']" class="form-control" value="0.00" readonly style="text-align: right;padding: 4px;"/></td><td><input type="text" name="igst_amt[' + num + ']" id="igst_amt[' + num + ']" class="form-control" value="0.00" readonly style="text-align: right;padding: 5px;"/></td><td><input type="text" class="form-control" name="linetotal[' + num + ']" id="linetotal[' + num + ']" autocomplete="off" readonly style="width:85px;text-align: right;padding: 4px;"><input type="hidden" class="form-control" name="avl_stock[' + num + ']" id="avl_stock[' + num + ']"  autocomplete="off"  style="width:50px;text-align: right" readonly value="0"><input name="mrp[' + num + ']" id="mrp[' + num + ']" type="hidden"/><input name="holdRate[' + num + ']" id="holdRate[' + num + ']" type="hidden"/></div><div style="display:inline-block;float:right"><i class="fa fa-close fa-lg" onClick="deleteRow(' + num + ');"></i></div></td></tr>';
            ...
            function calculatetotal() {
                ...
                for (var i = 0; i <= rowno; i++) {
                    ...
                    document.getElementById("grand_total").value = formatCurrency(Math.round(sum_total));
                        ...
                        <form id="frm2" name="frm2" class="form-horizontal" action="" method="post">
                                            ...
                                            <td class="col-md-2">
                                                <span id="pdtid0">
                                                    <select name="prod_code[0]" id="prod_code[0]" class="form-control selectpicker" required data-live-search="true" onChange="getAvlStk(0);checkDuplicate(0, this.value);">
                                                        ...
                                                        while ($br = mysqli_fetch_array($check1)) {
                                                            ?>
                                                            <option data-tokens="<?php echo $br['productname']; ?>" value="<?php echo $br['productcode']; ?>"><?= $br['productname'] . ' | ' . $br['productcolor'] . ' | ' . $br['productcode']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </span>
                                            </td>
                            ...
                            <div class="form-group">
                                <div class="col-md-10">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" name="tot_sgst_amt" id="tot_sgst_amt" class="form-control" value="0.00" readonly/>
                                    </div>
                                    <label class="col-md-3 control-label">Round Off</label>
                                    <div class="col-md-3">
                                        <input type="text" name="round_off" id="round_off" class="form-control" value="0.00" readonly/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-10">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" class="form-control span2" name="tot_cgst_amt"  id="tot_cgst_amt" value="0.00" readonly>
                                    </div>                                  
                            ...
                            <div class="form-group">
                                <div class="col-md-10">                                   
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" name="tot_igst_amt" id="tot_igst_amt" class="form-control" value="0.00" readonly/>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-10">
                                    ...
                                    <div class="col-md-3">
                                        <textarea name="delivery_address" id="delivery_address" class="form-control required" style="resize:none" required></textarea>
                                    </div>
                                   ...
                                   <label class="col-md-3 control-label">Invoice Date</label>
                                    <div class="col-md-3 input-append date">
                                        <div style="display:inline-block;float:left;">
                                            <input type="text" class="form-control span2" name="invoicedate"  id="invoicedate" style="width:180px;">
                                        </div>
