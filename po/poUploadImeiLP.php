...
if ($_POST['Submit'] == "Upload") {
    ...
    if($_FILES["attchfile"]["name"]) {
            ...
            for ($i = 0; $i < count($k); $i++) {
                ...
                if ($r[0] == '' && $r[1] == '' && $r[2] == '') {
                    ...
                    if ($part_code['prod_code'] != "") {
                        ...
                        header("Location:poUploadImeiLP.php?challan_no=" . $_POST['challan_no'] . "&msg=$msg_partcode" . $pagenav);
                        exit;
                    }
                   ...
                   // check imei1 and imei2 	
					...
					if ($imeidata == 0) {
                        ...
                        header("Location:poUploadImeiLP.php?challan_no=" . $_POST['challan_no'] . "&msg=$msg_imei" . $pagenav);
                        exit;
                    }
        ...
        if ($msg == '1') {
            ...
            header("Location:poUploadImeiLP.php?challan_no=" . $_POST['challan_no'] . "&msg=$msg" . $pagenav);
            exit;
        } 
         mysqli_close($link1);
		 }
