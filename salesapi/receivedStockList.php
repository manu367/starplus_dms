	...
	<div class="container-fluid">
    	<div class="row content">
    		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <div align="center">
                <button title="Receive invoice" type="button" class="btn btn-success" onClick="window.location.href='receiveStockList.php?userid=<?=$_REQUEST['userid']?>'"><i class="fa fa-level-down fa-lg"></i>&nbsp;&nbsp;Receive invoice</button>
                </div><br/>
                <div class="form-group"  id="page-wrap" style="margin-left:10px;">
                    ...
                    $sno = 0;
                    $sql = mysqli_query($link1,"SELECT * FROM sale_uploader WHERE to_location='".$owner_code."' ".$filter_str." AND status='Received' AND receive_by!='' GROUP BY doc_no,from_location,to_location,doc_date ORDER BY doc_date DESC LIMIT 0,10");
