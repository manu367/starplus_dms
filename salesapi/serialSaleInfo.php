...
$sql_data = "SELECT prod_code,prod_name,serial_no1 FROM sale_uploader WHERE from_location='".$from_location."' AND to_location='".$to_location."' AND doc_no='".$inv_no."' AND doc_date='".$inv_date."'";
